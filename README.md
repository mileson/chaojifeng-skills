...
| [`blender-product-film`](blender-product-film/docs/README.md) | 从一句话与项目定位制作产品 3D 宣传片 | 产品叙事与 ImageGen 素材<br>真实骨架、服装蒙皮与面部控制<br>布光、渲染续作、声音与交付验证 | App、软件服务、实体产品的使用场景宣传片 | `npx skills add mileson/chaojifeng-skills --skill blender-product-film` |
